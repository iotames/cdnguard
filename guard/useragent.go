...
func compileSuspiciousPatterns() []*regexp.Regexp {
	...
	// 去掉php正则，避免误伤。OPPO​​(一加 Ace 2天玑版​​)典型UserAgent: Mozilla/5.0 (Linux; U; Android 15; zh-cn; PHP110 Build/AP3A.240617.008) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/115.0.5790.168 Mobile Safari/537.36 HeyTapBrowser/40.10.2.1
